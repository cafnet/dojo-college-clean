...
jQuery(document).ready(function($){
  ...
  jQuery('.user_logo_button').uploadify({
    'swf'  : 'http://dev.dojo.college/wp-content/themes/apptual/uploader/ul_sn.swf',
    'uploader'    : 'http://dev.dojo.college/wp-content/themes/apptual/uploader/ul_sn.php',
    'buttonText' : 'Upload image',
    'cancelImg' : 'http://dev.dojo.college/wp-content/themes/apptual/uploader/cancel.png',
    'folder'    : '/wp-content/uploads/user_pics',
    'auto'      : true,
    'onUploadSuccess' : function(file, data, response) {
        jQuery('.avatar-handler img.logo').attr('src', 'http://dev.dojo.college/wp-content/uploads/user_pics/'+data);
